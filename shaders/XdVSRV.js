// Auto-generated. Wraps the raw Shadertoy GLSL
// source so it can be loaded as a classic <script> (no modules,
// no fetch). Exposes window.SHADER_XdVSRV = { id, title, author, channels, source }.
window.SHADER_XdVSRV = {
  "id": "XdVSRV",
  "title": "Glass and Gold Bubble",
  "scenes": ["own"],
  "group": "orig",
